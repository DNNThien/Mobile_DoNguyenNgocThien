...
export default function ChooseColor({ navigation, route }) {
  const blackPhone = require('../assets/vs_black.png');
  const bluePhone = require('../assets/vs_blue.png');
  const redPhone = require('../assets/vs_red.png');
  const silverPhone = require('../assets/vs_silver.png');
  const [colorPhone, setColorPhone] = useState(route.params.image);
  const [pricePhone, setPricePhone] = useState('1.790.000');
  return (
    <SafeAreaProvider>
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <View style={{ flex: 1, backgroundColor: '#C4C4C4' }}>
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate('Main Screen', { image: colorPhone, price: pricePhone })
            }>
