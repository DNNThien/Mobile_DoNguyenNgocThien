...
export default function Version1() {
  const serverURL =
    'https://68ce7dd46dc3f350777f2822.mockapi.io/DNNT_ReactNative/Product';
      ...
      <View
        ...
        <View
          ...
          <TouchableOpacity
            ...
            onPress={() => setEditProduct(item.id)}>
    ...
    >
        <ScrollView
          ...
          <View style={{ marginVertical: 5 }}>
            <Text style={{ fontSize: 18, fontWeight: 'bold' }}>Chọn Size</Text>
            <View
              style={{
                flexDirection: 'row',
                justifyContent: 'space-between',
          ...
          {/**Gia san pham */}
          <View style={{ marginTop: 10, marginBottom: 5 }}>
            <Text style={{ fontSize: 18, fontWeight: 'bold' }}>Giá (VND)</Text>
            <TextInput
              style={{
                height: 50,
                paddingHorizontal: 10,
